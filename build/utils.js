...
exports.htmlPlugins = function () {
  ...
  for (var pathname in pages) {
    // 配置生成的html文件，定义路径等
    let chunks = process.env.NODE_ENV === 'production' || process.env.NODE_ENV === 'production-dev' ? ['common/common', 'lib/vendor', 'lib/vendorStyle', pathname.replace(/^view\//, '')] : ['common/common', 'lib/vendor', 'lib/vendorStyle', pathname.replace(/^view\//, '')];
    var conf = {
