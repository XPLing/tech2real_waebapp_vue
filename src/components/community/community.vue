<template>
  <div class="g-community">
    ...
    <div class="g-main">
      <scroll ref="scroll" :pullup="true" :data="communityList" :probeType="probeType"
        ...
        <div>
          <ul class="community-list">
            <li class="item" v-for="(item, index) in communityList" :key="index">
              ...
              <div class="tools">
                <p class="item comment" @click.stop="selectItem(item)"><i
                  class="icon c-icon-comment-square"></i>{{item.replyCount}}</p>
                <p class="item like" @click.stop="operate('like',item)" :class="{'active': item.isLike === 'Y'}">
                  <i
    ...
    <p class="add-comment" @click="operate('addComment')">
    ...
    <keep-alive :include="keepAliveList">
      <router-view v-if="isRouterAlive" @commentUpdate="update" @dataUpdate="update"
                   :comment-form-placeholder="`@${placeholder}:`" :type="routerType"></router-view>
    </keep-alive>
